...
const PROJECTS = [
  ...
  /* ---- Sega Game Gear ---- */
  {
    ...
    milestones: [
      ...
      { label: "Rendering polish, GG hardware limits, and full-game validation — the long climb", done: false },
    ],
    ...
    projects: {
      ...
      "gg-pokered": {
        ...
        milestones: [
          ...
          "Rifiniture di rendering, limiti hardware GG e validazione a gioco intero — la lunga salita",
        ],
      },
      "wsc-bringup": {
    ...
    projects: {
      ...
      "gg-pokered": {
        ...
        milestones: [
          ...
          "レンダリングの仕上げ、GGのハードウェア制限、全ゲーム検証 — 長い登り",
        ],
      },
      "wsc-bringup": {
